<?php
			...
			if($_POST['MotDePasse']===$_POST['ConfirmationMDP'])
		{
			...
			$req = $bdd->prepare('INSERT INTO membres(ID_Membres,Nom, Prénom,Ville actuelle,Adresse,Date de Naissance,Téléphone mobile,Téléphone fixe,Email,Mot de passe) VALUES(?,?,?,?,?,?,?,?)');
			$req->execute(array(
			"",
			$_POST['NOM'],
			$_POST['Prenom'],

...
<html>
	 ...
	 <head><meta charset="utf-8"/>
		...
		<div class="header"><h1 class="adresse">Connexion...</h1><p><h2 class="slogan">Chargement des données personnelles</h2></p>
		<nav>
            <ul class="menu">
				<div class="section">
				<ul id="Connex">
							...
							<ul>
									<li>		
											<form action="ConnexionMembres.php" class="form-container"method="POST">
												...
												<input class="submit-button" type="submit" value="Valider" name="bouton" />
												</div>
											</form>
									</li>
							</ul>
